...
@Component({
  selector: 'app-vs-h2h-matches',
  templateUrl: './vs-h2h-matches.component.html',
  styleUrls: ['./vs-h2h-matches.component.scss']
})
export class VsH2hMatchesComponent implements OnInit {
