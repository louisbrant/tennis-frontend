...
@Component({
  selector: 'app-current-event-stats',
  templateUrl: './current-event-stats.component.html',
  styleUrls: ['./current-event-stats.component.scss']
})
export class currentEventStatsComponent implements OnInit {
