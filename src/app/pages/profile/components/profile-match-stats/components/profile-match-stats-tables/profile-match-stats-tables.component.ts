...
export class ProfileMatchStatsTablesComponent implements OnInit {
  ...
  activeGroups: TabActiveInterface[] = [
    { name: 'All', active: 'all', isActive: true },
    { name: 'Hard', active: 'hard', isActive: true },
    { name: 'Clay', active: 'clay', isActive: true },
    { name: 'Grass', active: 'grass', isActive: true },
    { name: 'Indoor', active: 'indoor', isActive: true },
  ]
  ...
  private fetchProfileMatchStats() {
    console.log("DDDD", this.profileName, this.filtersFormGroup.value);
  ...
  public changeActiveGroup(active: TabActiveInterface) {
    this.getFormControl(active.active);
    this.filtersFormGroup.value.court = active.active;
    this.fetchProfileMatchStats();
  }
